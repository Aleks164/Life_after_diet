...
export const LOGGED_ROUTE = "/costacc";
...
export const DietDefenition = {
  ...
  2: "The keto diet is based more on the ratio of fat, protein, and carbs in the diet rather than specific ingredients. Generally speaking, high fat, protein-rich foods are acceptable and high carbohydrate foods are not. The formula we use is 55-80% fat content, 15-35% protein content, and under 10% of carbohydrates.",
  3: "No ingredients may contain meat or meat by-products, such as bones or gelatin.",
  4: "All ingredients must be vegetarian and none of the ingredients can be or contain egg.",
  5: "All ingredients must be vegetarian and none of the ingredients can be or contain dairy.",
  6: "No ingredients may contain meat or meat by-products, such as bones or gelatin, nor may they contain eggs, dairy, or honey.",
  7: "Everything is allowed except meat and meat by-products - some pescetarians eat eggs and dairy, some do not.",
