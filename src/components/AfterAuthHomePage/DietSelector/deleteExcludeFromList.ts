...
export function deleteExcludeFromList(deletingIngridient: string, { settings, setRequestSettings }: SelectorParamType) {
    const filtredList = settings.excludeIngridientsSelector.excludeIngridients.filter(
