...
export const DietCooseField = ({
  ...
  function dietOptionTumbler(
    ...
    if (tumblerStatus) {
      newDietStatus = {
        ...settings,
        dietSelector: { diet: "", status: !tumblerStatus },
      };
    } else {
      newDietStatus = {
        ...settings,
        dietSelector: { ...settings.dietSelector, status: !tumblerStatus },
      };
    }
  ...
  return (
    <div className="dietCooseField">
      <label>
        ...
        <div>
          <OnOffTumbler
            onDragStartFunction={dietOptionTumbler}
            onClickFunction={dietOptionTumbler}
            tumblerStatus={curDietstatus}
          />
        </div>
      </label>
    </div>
